    ...
    return (
        <section className='bg-[#f8f8fd] '>
            <div className='max-w-360 mx-auto px-4 md:px-31 flex items-center gap-2 pt-6 md:pt-20'>
                ...
                {/* title+img+subtitle */}
                    <h1 className='font-semibold text-5xl md:text-7xl title leading-[110%]'>Discover <br /> more than <br /> <span className='text-[#26A4FF]'>5000+ Jobs</span> </h1>
                    <img src={line} alt="line" className='mt-3' />
                    <p className=' text-[18px] md:text-[20px] text-[#515B6F] my-5.75'>Great platform for the job seeker that searching for new career heights and passionate about startups.</p>
                ...
                <div className='flex md:flex-row flex-col items-center bg-white p-4 rounded-sm w-[343px] md:w-[852px] relative z-50'>
                    ...
                    {/* Search Button */}
                    <button className='bg-[#4640DE] w-full md:w-1/3 text-white px-6.75 py-3.5 text-sm font-semibold hover:bg-[#3730c4] transition-colors whitespace-nowrap'>
                        Search my job
                    </button>
                ...
                {/* right side */}
            <div style={{ backgroundImage: `url(${bg})` }} className='w-1/2 bg-cover bg-center bg-no-repeat h-150 -mt-80 hidden md:flex'>
